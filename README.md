...
The agent ingests a company’s 10-K filing end-to-end: extracts structured metrics, computes KPIs, analyzes risks, summarizes MD&A, retrieves live market data, validates numerical claims through a Hallucination Guard, generates a polished investment memo, and supports grounded Q&A — all in under few minutes.
________________________________________
**Problem Statement**
...
**Architecture Diagram** !<img width="2371" height="1682" alt="architecture design" src="https://github.com/user-attachments/assets/3940dc8f-6e92-4f07-a721-25080819c2b8" />
________________________________________
...
•	Adding database for memory and session
